...
<%
String mapConfig = renderRequest.getPreferences().getValue("mapConfig", "");

if((request.getParameter("mapConfig")!=null)&&(!request.getParameter("mapConfig").equals(""))){
mapConfig = request.getParameter("mapConfig");
renderRequest.getPreferences().setValue("mapConfig",request.getParameter("mapConfig"));
...
<table>
            <tr>
                ...
                <td><input name="mapConfig" type="text" size="30" value="<%= mapConfig %>"></td>
            </tr>
            <tr>
                <td></td>
